...
[[ -f "$T1/docs/slos.md" ]] || fail "docs/slos.md from course shape"
grep -q "BIO 101" "$T1/docs/slos.md" || fail "slos course-number"
grep -q "Intro Biology" "$T1/docs/slos.md" || fail "slos course-title"
